SUBROUTINE forward(y0, n_time, y_history)
  ...
  USE saprc99_Global, ONLY: VAR, SUN
      ...
      INTEGER :: n_time
      REAL(kind=8) :: y0(74), y_history(75, n_time) ! also record SUN
...
SUBROUTINE onestep(y0_list, n_sample, y1_list)
  ...
  USE saprc99_Global, ONLY: VAR, SUN
      ...
      REAL(kind=8) :: y0_list(75, n_sample), y1_list(74, n_sample)
