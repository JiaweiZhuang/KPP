...
! 
! File                 : ros_Integrator.f90
! Time                 : Sat Jan 20 20:30:48 2018
! Working directory    : /home/zhuangjw/KPP/my_tests/test_f2py
! Equation file        : ros.kpp
! Output root filename : ros
! 
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
MODULE ros_Integrator

  USE ros_Parameters, ONLY: NVAR, NFIX, NSPEC, LU_NONZERO
  USE ros_Global
  IMPLICIT NONE
  PUBLIC
  SAVE
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE ros_Parameters, ONLY: NVAR, LU_NONZERO
 USE ros_Global, ONLY: FIX, RCONST, TIME
 USE ros_Function, ONLY: Fun
 USE ros_Rates, ONLY: Update_SUN, Update_RCONST
!~~~> Input variables
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE ros_Parameters, ONLY: NVAR, LU_NONZERO
 USE ros_Global, ONLY: FIX, RCONST, TIME
 USE ros_Jacobian, ONLY: Jac_SP, LU_IROW, LU_ICOL
 USE ros_LinearAlgebra
 USE ros_Rates, ONLY: Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
